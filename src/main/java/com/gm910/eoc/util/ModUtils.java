package com.gm910.eoc.util;

import java.util.HashSet;
import java.util.Set;

import com.gm910.eoc.main.ElementsOfChaosMod;
...
public class ModUtils {
	 ...
	 * @param value
	 */
	public static <T> void forceRegister(IForgeRegistry<T> registry, Identifier location, T value) {
	...
	public static Identifier path(String path) {
		return Identifier.fromNamespaceAndPath(ElementsOfChaosMod.MODID, path);
	}

	/**
	 * If this Identifier is "minecraft:X" then shorten it to just X
	 * 
	 * @param loc
	 * @return
	 */
	public static String toShortString(Identifier loc) {
